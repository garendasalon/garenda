...
while ($row = mysqli_fetch_array($ret)) {
    ...
    <a href="tel:09435059030"><?php echo $row['MobileNumber']; ?></a>
    </li>

    <li><i class="fa fa-envelope-o"></i>
    <a href="mailto:garenda@gmail.com"><?php  echo $row['Email'];?></a>
    </li>
<?php } ?>
                        </ul>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="copyright-content">
                            <p><i class="fa fa-copyright"></i> Grenda's Best Salon Management System 2023 || Created by
                                <span>Group HAG</span></p>
                        </div>
                    </div>
                </div>
            </div>
