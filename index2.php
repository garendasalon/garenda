...
<body>
  ...
  <div class="space-medium bg-default">
    <div class="container">
      <div class="row">
        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12"><img src="images/C2.jpeg" alt=""
...
<!-- mission vision end -->
  ...
  <div class="what-we-do">
    <h2>What We Do</h2>
    <ul>
      <li> <i class="fa fa-check-circle-o"></i> <b>Haircuts:</b> Our stylists and barbers are experts in haircuts,
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="service">
            ...
            <p>Our stylists and barbers are experts in haircuts, from classic cuts to modern styles. We take the
